...
// 전역변수로 선언한 것
// 배열이니 인덱스로 전달주는 게 해당값만 줘서 깔끔하긴 하지만 Int만 넘어오면 헷갈릴 수 있음

let adInfoData: [InfoData] = [
    InfoData(listImage: "2022 green", category: "iPhone", adTitle: "초록으로 물들다", adDescription: "iPhone 13과 iPhone 13 Pro의 새로운 컬러, \nGreen을 소개합니다.", adDate: "2022.3.25", adInfoImage: "2022 green main", image1: "2022 green1", image2: "2022 green2", image3: "2022 green3", image4: "2022 green4", albumImage: "2022 green album", songTitle: "The Jungle", singer: "Oliver Malcom", debutDate: "2020.2.20", genre: "Pop", albumTitle: "'The Jungle'", releaseDate: "2021.4.21", singerImage: "2022 green singer", youtube: "2022 green youtube"),
    
    InfoData(listImage: "2022 hollywood", category: "iPhone", adTitle: "할리우드가 손 안에", adDescription: "iPhone 카메라의 역대급 진화, \niPhone 13 Pro. 새롭게 선보이는 시네마틱 모드로 극적인 초점 전환. 3배 광학 줌과 첨단 저조도 촬영 성능. 동영상도 접사로 촬영. 게다가 더욱 향상된 흔들림 보정에 ProRes 촬영까지. 이제, 할리우드가 손안에.", adDate: "2021.10.3", adInfoImage: "2022 hollywood main", image1: "2022 hollywood", image2: "2022 hollywood2", image3: "2022 hollywood3", image4: "2022 hollywood4", albumImage: "2022 hollywood album", songTitle: "Like a movie", singer: "Labrinth", debutDate: "2010.9.27", genre: "R&B/Soul, POP", albumTitle: "'Like a movie'", releaseDate: "2019.11.8", singerImage: "2022 hollywood singer", youtube: "2022 hollywood youtube"),
